...
var Swiper = (function () {
 ...
 function V(e) {
  ...
  if (
   (new Date().getTime(), i.isMoved && i.allowThresholdMove && w !== s.touchesDirection && b && y && Math.abs(g) >= 1)
  )
   return (
 ...
 const ge = [
  ...
  function (e) {
   ...
   const i = (e, t, s) => {
    ...
    a ||
     ((a = v("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "left" : "top")).split(" "))), e.append(a)),
     i ||
